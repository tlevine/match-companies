...
MATCHNAMES = [
    (r'^address$', 'address'),
    (r'^name$', 'name'),
    ('opening.*price', 'original.price.opening'),
    ('price.*opening', 'original.price.opening'),
    ('evaluat(?:ed|ion).*price', 'original.price.evaluated'),
    ('country', 'country'),
    (r'reason.*rejection', 'reason.rejection'),
    (r'contract ?price', 'original.price.contract'),
    ('duration', 'duration'),
